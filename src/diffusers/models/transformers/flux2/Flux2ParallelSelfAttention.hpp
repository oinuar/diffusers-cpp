...
public:
    ...
    virtual Tensor forward(
        ...
        hidden_states = to_qkv_mlp_proj->forward(runtime, hidden_states);
        ...
        mlp_hidden_states = mlp_act_fn->forward(runtime, mlp_hidden_states);
        ...
        hidden_states = to_out->forward(runtime, hidden_states);
