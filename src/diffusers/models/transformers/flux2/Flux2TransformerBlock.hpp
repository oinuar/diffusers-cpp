...
public:
    ...
    std::tuple<Tensor, Tensor> forward(
        ...
        auto norm_hidden_states = norm1->forward(scope, hidden_states);
        ...
        auto norm_encoder_hidden_states = norm1_context->forward(scope, encoder_hidden_states);
        ...
        norm_hidden_states = norm2->forward(scope, hidden_states);
        ...
        auto ff_output = ff->forward(scope, norm_hidden_states);
        ...
        norm_encoder_hidden_states = norm2_context->forward(scope, encoder_hidden_states);
        ...
        auto context_ff_output = ff_context->forward(scope, norm_encoder_hidden_states);
